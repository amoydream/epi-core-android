...
public class MainActivity extends ActionBarActivity implements Readers.RFIDReaderEventHandler {
    ...
    public static final String MSG_READ = "Reading Tags";
    public static final String MSG_WRITE = "Writing Data";
    public static final String MSG_LOCK = "Executing Lock Command";
    public static final String MSG_KILL = "Executing Kill Command";
    public static Timer t;
    public static ArrayList<BluetoothDeviceFoundHandler> bluetoothDeviceFoundHandlers = new ArrayList<>();
    public static ArrayList<BatteryNotificationHandler> batteryNotificationHandlers = new ArrayList<>();
    public boolean isInventoryAborted;
    public boolean isLocationingAborted;
    public int accessTagCount;
    ...
    public String[] mOptionTitles;
    public Boolean isTriggerRepeat;
    public boolean pc = false;
    public boolean rssi = false;
    public boolean phase = false;
    public boolean channelIndex = false;
    public boolean tagSeenCount = false;
    public boolean isDeviceDisconnected = false;
    ...
    public boolean onPrepareOptionsMenu(Menu menu) {
        ...
        if (drawerOpen) {
            ...
            if (getSupportActionBar() != null) {
                ...
                if (getFragmentManager() != null && getFragmentManager().findFragmentByTag(TAG_CONTENT_FRAGMENT) != null &&
                        (getFragmentManager().findFragmentByTag(TAG_CONTENT_FRAGMENT) instanceof PreFilterFragment ||
                                getFragmentManager().findFragmentByTag(TAG_CONTENT_FRAGMENT) instanceof AccessOperationsFragment)) {
                        ...
                        if (!tagId.isEmpty()) {
                            ...
                            if (!offsetText.getText().toString().isEmpty()) {
                                if (!lengthText.getText().toString().isEmpty()) {
                                    ...
                                    progressDialog.show();
                                    final Fragment fragment = getFragmentManager().findFragmentByTag(TAG_CONTENT_FRAGMENT);
